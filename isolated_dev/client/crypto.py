...
def main():
	...
	img_path = "encrypted(1).png"
	hidden_msg = lsb.reveal(img_path)
	encrypted_message_decoded = base64.b64decode(hidden_msg.encode())
	our_msg = encrypted_message_decoded.hex()
	#print(our_msg)
	ret = interpret_msg(our_msg, byte_representation)
	#print(ret)
